...
def build_interpretation(replay, decision_status):
    ...
    if zero_or_missing_reference:
        ...
        blockers.append("Some manual action records have missing or zero action price: " + ", ".join(unique))
        next_actions.append("For useful replay percentage, log future manual actions with a non-zero reference/action price.")
