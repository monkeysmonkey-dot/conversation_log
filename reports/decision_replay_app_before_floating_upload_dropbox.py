...
# ============================================================
# Hermes Universal Circular Upload Button
# ============================================================
...
def render_hermes_universal_upload_button():
    ...
    if _quick_upload_open == "1":
        ...
        st.caption("Upload any portfolio, tax, account, research, corporate, mutual fund, retirement, screenshot, CSV, Excel, or manual note file. Hermes stores it in Document Inbox for sorting confirmation.")
        ...
        _quick_files = st.file_uploader(
            ...
            key="hermes_universal_quick_upload"
        )
        ...
        st.markdown('[Close upload panel](?quick_upload=0)')
