...
# ============================================================
# Hermes Universal Floating Controls
# ============================================================

def render_hermes_universal_floating_controls():
    ...
    def _run_hidden(cmd, **kwargs):
        # Prevent flashing PowerShell/CMD windows on Windows.
        try:
            if cmd and cmd[0] == "py":
            ...
            # Fallback for environments that do not support creationflags.
    ...
    st.markdown(f"""
    <style>
    .hermes-refresh-circle,
    .hermes-upload-circle {{
        position: fixed;
        right: 1.05rem;
        z-index: 2147483646;
    ...
    .hermes-refresh-circle:hover,
    .hermes-upload-circle:hover {{
    ...
    <a class="hermes-refresh-circle" href="?hermes_refresh=1" target="_self" title="Refresh current page">⟳</a>
    <a class="hermes-upload-circle" href="{_upload_href}" target="_self" title="Quick upload">↥</a>
    """, unsafe_allow_html=True)
    ...
    if _quick_upload_open == "1":
        ...
        _quick_files = st.file_uploader(
            ...
            key="hermes_universal_floating_upload"
        )
...
render_hermes_universal_floating_controls()
