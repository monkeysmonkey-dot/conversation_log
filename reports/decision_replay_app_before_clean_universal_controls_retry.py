...
def render_hermes_universal_floating_controls():
    ...
    .hermes-floating-upload-title {{
        ...
        width: 38rem;
        z-index: 2147483645;
        padding: 1.10rem 1.20rem 0.90rem 1.20rem;
    ...
    <a class="hermes-refresh-circle" href="?hermes_refresh=1" title="Refresh current page">⟳</a>
    <a class="hermes-upload-circle" href="{_upload_href}" title="Quick upload">↥</a>
    """, unsafe_allow_html=True)
